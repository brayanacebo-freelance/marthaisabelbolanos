...
jQuery(function($) {
	...
	pyro.init = function() {
		...
		$(window).resize(function(){
			...
			$(".main-content section#content").css({
				'min-height' :	 win_height - 134
			})
			...
			var height_nav = $(".main-menu").height() - 60;
			$(".primary-nav").css({
				'height' : height_nav
			});
			/* Altura dinámica del menú lateral*/
			var height_nav_sec = $(".main-menu").height() - $(".second-nav #shortcuts").height() - 60;
			$(".secondary-nav").css({
				'height' : height_nav_sec
			});
			
			/* Ancho dinámico del main content */
			$(".main-content").css({
				'width' : win_width
			});
			$(".main-active").css({
			...
			$(".main-content .subbar").css({
				'width' : win_width 
			});
			$(".main-active .subbar").css({
				'width' : win_width - 250
			});
			
			$(".main-content .sections_bar").css({
				'width' : win_width 
			});
			$(".main-active .sections_bar").css({
				'width' : win_width - 250
			});
		});
		...
		if(win_width <= 768){
			...
			$(".main-content").addClass("main-active");
		...
		/* Menú lateral */
		$('.topbar ul li ul').each(function(){
			$("li:last", this).addClass("thelast");
			$("li:first", this).addClass("first");
		});
		$('.topbar .primary-nav > li:not(#dashboard-link) > a').click(function(){
			$("ul", $(this).parent()).slideToggle(500);
			
			if($(this).parent().hasClass("open")){
				$(this).parent().removeClass("open");
			}else{
				$('.topbar ul li.open ul').slideToggle(500);
				$('.topbar ul li.open').removeClass("open");
		...
		/* Acción open/close del menú lateral*/
		$(".menu-btn").click(function(){
			var win_width = document.documentElement.offsetWidth;
			$(".main-content").removeClass("second-active");
			$(".second-nav-btn").removeClass("active");
			$(".second-nav").removeClass("active");
			if($(this).hasClass("active")){
				$(this).removeClass("active");
				$(".main-menu").removeClass("active");
				$(".main-content").removeClass("main-active");
				$(".main-content").css({
					'width' : '100%'
				})
				$(".subbar").css({
		...
		/* Acción open/close del menú lateral secundario*/
		$(".second-nav-btn").click(function(){
			...
			if($(this).hasClass("active")){
				...
				$(".main-content").addClass("second-active");
				$(".main-content").css({
					'width' : '100%'
				})
				$(".subbar").css({
		...
		$(".topbar-form input").focusout(function(){
		...
		if($(".sections_bar").length || $("#shortcuts").length){
			$(".subbar").addClass("has-second-nav");	
		}
		...
		$(".sortable .live").click(function(){
			if($(this).hasClass("selected")){
				...
				$(".sortable .selected").removeClass("selected");
		...
		$(".sf-btn").click(function(){
			if($(this).hasClass("active")){
				$("#filters", $(this).parent().parent()).hide();	
			}else{
				$("#filters", $(this).parent().parent()).show();	
			}
